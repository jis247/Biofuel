...
Public Class Customer_bill_rep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Biofuel.Customer_bill_rep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustomer_bill_rep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Customer_bill_rep = New Customer_bill_rep()
        rpt.Site = Me.Site
        Return rpt
    End Function
