...
Public Class Farmer_bill_rep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Biofuel.Farmer_bill_rep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFarmer_bill_rep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Farmer_bill_rep = New Farmer_bill_rep()
        rpt.Site = Me.Site
        Return rpt
    End Function
