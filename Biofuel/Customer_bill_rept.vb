...
Public Class Customer_bill_rept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Biofuel.Customer_bill_rept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustomer_bill_rept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Customer_bill_rept = New Customer_bill_rept()
        rpt.Site = Me.Site
        Return rpt
    End Function
