...
Public Class Supplier_bill_rep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Biofuel.Supplier_bill_rep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupplier_bill_rep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Supplier_bill_rep = New Supplier_bill_rep()
        rpt.Site = Me.Site
        Return rpt
    End Function
